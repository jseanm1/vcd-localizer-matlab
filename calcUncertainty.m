function [cov_Xr] = calcUncertainty(X_ort, X_opt)
    ...
    H(3,3) = getd2vcd_dphir2(DTobj1, DTobj2, DT1_dxobj, DT1_dyobj, DT2_dxobj, DT2_dyobj, DT1_dx2obj, DT1_dy2obj, DT2_dx2obj, DT2_dyobj, X_ort, X_opt, X_o, n);
...
function [d2vcd_dxrdr] = getd2vcd_dxrdr(DTobj1, DTobj2, DT1_dxobj, DT1_dyobj, DT2_dxobj, DT2_dyobj, DT1_dx2obj, DT2_dx2obj, X_ort, X_opt, X_o, n)
    ...
    for i=1:n
        ...
        comp3 = DT2_dxobj(y,x) * (DT1_dxobj(y,x)*s + DT2_dyobj(y,x)*c);
