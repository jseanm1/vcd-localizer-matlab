...
% clc
% 
% load thesis_intel_localized.mat
% load intel_data.mat
...
% plot((Pose(2:10:3490,1)./0.05),(Pose(2:10:3490,2)./0.05),'.b')
% legend('GMapping Trajectory', 'Optimization Based Localizer')
...
% hold on
% zoom(2)
% plot((Pose(2:1:lim,1)./0.05),(Pose(2:1:lim,2)./0.05), 'Marker', '.', 'MarkerSize', 3, 'Color', [0.4660 0.6740 0.1880], 'LineStyle', '-')
% legend('Optimization Based Localizer Trajectory')
% 
...
figure
hold on
plot(pcx, -pcy, 'Marker', '.', 'MarkerSize', 3, 'Color', [0.4660 0.6740 0.1880], 'LineStyle', 'none')
axis equal
box on
xticks([])
yticks([])
